...
<main class="about-section">
    <div class="container about-container">
        ...
        <div class="about-content">
            <span class="section-title">Established 2023</span>
        ...
        <style>
            ...
            .about-image {
                width: 100%;
                height: 500px;
                /* Samakan dengan tinggi di CSS utama Anda */
                background-size: cover;
                background-position: center;
            }
        ...
        <script>
            let currentSlide = 0;
            const totalSlides = 4; // Jumlah gambar Anda
            ...
            function startSlide() {
                ...
                // Geser container berdasarkan persentase (1 gambar = 25% jika total 4 gambar)
